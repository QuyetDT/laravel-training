                ...
                <div class="product-image-wrapper">
                    <div class="single-products">
                        <div class="productinfo text-center">
                            <img src="{{ 'public/frontend/images/home/' . $product->image }}" alt="" />
                            <h2>{{ $product->price }}</h2>
                            <p>{{ $product->product_name }}</p>
                            <a href="{{ URL::to('/add_to_cart/' . $product->id) }}" class="btn btn-default add-to-cart"><i
                        ...
                        <div class="product-overlay">
                            <div class="overlay-content">
                                <h2>{{ $product->price }}</h2>
                                <p>{{ $product->product_name }}</p>
                                <a href="{{ URL::to('/add_to_cart/' . $product->id) }}"
